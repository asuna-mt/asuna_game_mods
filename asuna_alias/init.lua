...
minetest.register_alias("naturalbiomes:coconut_trapdoor","everness:trapdoor_bamboo")
minetest.register_alias("naturalbiomes_coconut_door","everness:door_bamboo")